...
class Simplex:
    ...
    def __init__(self, a: List[List[float]], c, b: List[float]):
        """
    ...
    def run(self) -> List[float]:
        ...
        while flag and cont < MAX_ITER:
            w = copy.deepcopy(cb)
            for g, r in changes_buff_e:  # BTRAN process
                w[r] = np.dot(w, g)
            ...
            for i in range(len(changes_buff_e)):  # FTRAN process
            ...
            new_column = -y/y[r]
            new_column[r] = 1/y[r]
            changes_buff_e.insert(0, (new_column, r))
